...
| G3 | SEAM-03 checklist has a completed rehearsal run for submit/retry/approval/persist/reject/retention/signed-URL egress with blocker capture. | pass | 2026-03-10 | `docs/EXTRACT-006-SEAM-03-cutover-rehearsal-checklist.md` (run `SEAM-03B-2026-03-10T10:51:28Z`; checks `SEAM-03-CHK-01`..`SEAM-03-CHK-05` all pass) |
